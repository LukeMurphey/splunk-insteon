...
define(function(require, exports, module) {
    ...
    var InsteonDataCellRenderer = BaseCellRenderer.extend({
	     ...
	     defaults: {
	    	 status_descriptions : { 'clear' : 'All Clear', 'alert' : 'Alert'}
	     },
	     ...
	     initialize: function() {
	            ...
	            this.status_descriptions = options.status_descriptions;
	     },
		 
		 render: function($td, cell) {
			 
			 // Handle problem state (wet)
			 if(cell.field === "status" && cell.value === "1" || cell.value === 1 || cell.value === "wet"){
				 ...
				 $td.html('<span style="float: right; color: #d85d3c; font-weight: bold"><i style="font-size: 14pt;" class="icon-alert icon-warning"></i> ' + this.status_descriptions['alert'] + '</span>');
			 }
			 
			 //Handle non-problem state (dry)
				 ...
				 $td.html('<span style="float: right; color: #65a637; font-weight: bold"><i style="font-size: 14pt;" class="icon-box-checked"></i> ' + this.status_descriptions['clear'] + '</span>');
			 ...
			 else if(cell.field === "status" && cell.value === "-1" || cell.value === -1){
				 $td.html('<span style="float: right; color: #d85d3c; font-weight: bold"><i style="font-size: 14pt;" class="icon-alert icon-warning"></i> Unknown</span>');
			 }
